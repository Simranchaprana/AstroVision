...
using Vuforia;
public class ZodiacDataCloudReco : MonoBehaviour
{
    public ZodiacDataUIManager zodiacDataUIManager; // Replace StudentDataUIManager studentDataUIManager;
    ...
    public void OnNewSearchResult(CloudRecoBehaviour.CloudRecoSearchResult cloudRecoSearchResult)
    {
        ...
        zodiacDataUIManager.LoadData(json); // Replace studentDataUIManager
    ...
    {
        zodiacDataUIManager.ClearUI(); // Replace studentDataUIManager
